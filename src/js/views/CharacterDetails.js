...
import "../../styles/demo.css";
 ...
 const CharacterDetails = () => {
  ...
  console.log("I need to render the Characters ", params.char_id)
  const myCharacters = store.characters.find(c => c.uid === params.char_id)
  if(myCharacters === null || myCharacters === undefined) {
  ...
  <div className="row g-0">
    ...
    <div className="col-md-8 text-center">
      <div className="card-body px-5">
        <h5 className="card-title">{myCharacters.name}</h5>
